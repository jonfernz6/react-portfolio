...
const dataabout = {
    ...
    aboutme: "Clouds may float aimlessly in the sky, but not on my watch. I bring order to cloud chaos, making tech work smarter, not harder. Whether it’s scaling workloads, crafting SoWs that could win a Pulitzer (if they gave awards for that), or brainstorming outside-the-box solutions, I do it all with a mix of strategy, precision, and a good sense of humor.",
};
const worktimeline = [{
